      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="relative z-9999 border-t border-white/6 bg-[#050816] md:hidden"
          >
              ...
              <div className="flex flex-col">
                {links.map((link) => (
                  <a
                    ...
                    href={link.href}
                    onClick={(e) => handleNavigation(e, link.href)}
                    className="flex min-h-13 items-center border-b border-white/5 py-4 text-sm font-medium text-slate-300 transition-colors duration-200 hover:text-blue-400 active:text-blue-400"
                  >
                    {link.name}
                  </a>
                ))}
